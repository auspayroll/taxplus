...
urlpatterns = patterns('',
	...
	url(r'^admin/tax/tax/business/(?P<pk>\d+)/fees/$', taxplus_views.business_fees, name='business_fees'),
	url(r'^admin/tax/tax/property/(?P<pk>\d+)/fees/$', taxplus_views.property_fees, name='property_fees_link'),
	...
	url(r'^admin/paylandlease/(?P<pk>\d+)/$', taxplus_views.payLandLease, name='paylandlease'),
