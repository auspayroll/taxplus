...
class CollectionUpdateForm(forms.ModelForm):
	...
	def __init__(self, *args, **kwargs):
		...
		self.fields['utility'].widget.attrs['disabled'] = True
		self.fields['date_from'].widget.attrs['disabled'] = True
		self.fields['date_to'].widget.attrs['disabled'] = True

	def is_valid(self, *args, **kwargs):

		self.fields.pop('utility')
		self.fields.pop('fee_type')
		self.fields.pop('date_from')
		self.fields.pop('date_to')
		return super(CollectionUpdateForm, self).is_valid(*args, **kwargs)
