...
function showMultiplePropertyResults(data)
{
	...
	if(properties.length>0)
	{
		...
		row+=								"<tr>";
		row+=									"<td class='firstrowfirstcolumn'>UPI</td>";
		...
		for(i=0;i<properties.length;i++)
		{
			...
			{
				row+=							"<tr>";
				row+=								"<td class='firstcolumn'><a href='/admin/tax/tax/declarevalue_tax/?plot_id="+ plot_id +"'>" + property['upi'] + "</a></td>";
			...
			else
			{
				...
				row+=							"<tr>";
				row+=								"<td class='firstcolumn'><a href='/admin/tax/tax/declarevalue_tax/?plot_id="+ plot_id +"'>" + plot_id + "</a></td>";
...
function showSinglePropertyResult(data)
{
	...
	if(properties.length>0)
	{
		for(i=0;i<properties.length;i++)
		{
			...
			row+=									"<div class='box_detail'><strong>UPI:</strong> "+upi+"</div>";
			...
			row+=												"<div style='width:250px; float:left;'><input type='text' name='declare_amount' id='declare_amount'/> (RWF)</div>";
			...
			row+=												"<div style='width:250px; float:left;'><input id='citizen_id' type='text' name='citizen_id'/></div>";
			row+=												"<div style='clear:both'></div>";
			row+=											"</td>";
			row+=										"</tr>";
			row+=										"<tr>";
			row+=											"<td colspan='2'><button id='button" + plot_id + "' type='button'>Declare</button></td>";
			row+=										"</tr>";
			row+=										"</table>";
			row+=									"</div>";									
		   ...
		   $('button[id^="button"]').click(function(){
				...
				{
					querystring = "plot_id="+plot_id+"&amount="+amount+"&citizen_id="+citizen_id;
					$.ajax({
						type:"get",
