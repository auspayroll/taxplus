...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Media.missing'
        db.add_column(u'media_media', 'missing',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Media.restored'
        db.add_column(u'media_media', 'restored',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Media.missing'
        db.delete_column(u'media_media', 'missing')

        # Deleting field 'Media.restored'
        db.delete_column(u'media_media', 'restored')
    ...
    models = {
        ...
        u'media.media': {
            ...
            'missing': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            ...
            'property': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['property.Property']", 'null': 'True', 'blank': 'True'}),
            'restored': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
